    ...
    submitForm() {
      ...
      this.afAuth.auth.createUserWithEmailAndPassword(
        ...
        .then((response) => {
          ...
          this.addDados('razaoSocial', this.registerForm.value.razaoSocial);
          this.addDados('cnpj', this.registerForm.value.cnpj);
          this.addDados('emailInstit', this.registerForm.value.email);
